...
const ITENS_ADMIN = [
  { id: "notificacoes", rotulo: "Notificações", rota: "/admin/notificacoes", badge: 3 },
  { id: "inicio", rotulo: "Visão geral", rota: "/admin" },
  { id: "criar", rotulo: "Gerenciar ocorrências", rota: "/admin/ocorrencias" },
  { id: "mapa", rotulo: "Mapa", rota: "/admin/mapa" },
  { id: "chat", rotulo: "Bate-papo", rota: "/admin/chat" },
  { id: "perfil", rotulo: "Meu perfil", rota: "/admin/perfil" },
];
export default function Sidebar({ role = "cidadao" }) {
  const itens = role === "admin" ? ITENS_ADMIN : ITENS_CIDADAO;
  const inicio = role === "admin" ? "/admin" : "/app";
  const sair = () => { sessionStorage.clear(); window.location.href = "/loginadm"; };
  return (
    <aside className="sidebar">
      <NavLink to={inicio} end className="sidebar-logo">
      ...
      <nav className="sidebar-nav">
        ...
        <button type="button" className="sidebar-item" onClick={sair}>
          <span className="sidebar-item-conteudo">
            {ICONES.sair}
            <span>Sair</span>
          </span>
